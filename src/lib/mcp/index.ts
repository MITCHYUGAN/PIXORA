...
export default defineMcp({
  ...
  version: "0.1.0",
  instructions:
    "Tools for PIXORA, a team bug tracker. Use `list_bugs` to browse or search bugs, `get_bug` for full detail plus comments, `create_bug` to file a report, `update_bug` to change status/severity/assignee, and `add_comment` to discuss a bug. Bugs are referenced by tracking ID (e.g. BUG-1234) or UUID.",
